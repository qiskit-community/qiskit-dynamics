...
change significantly. For example for :math:`J=1` the collective Bloch
vector will significantly tilt along :math:`+x`, while for :math:`J=3` it
will significantly shorten (the steady state becomes a mixed state),
becoming tilted along :math:`-y`. This complex dependence of the
