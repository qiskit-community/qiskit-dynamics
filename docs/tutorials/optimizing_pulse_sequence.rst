...
Next, we construct a pulse schedule using parametrized GaussianSquare pulse, convert to a signal, and 
...
We set parameters sigma and width as :math:`initial_params = np.array([10, 10,])`.
The shape of the pulse is here before the optimization.
