...
from qiskit_dynamics.pulse import instructions as pulse_inst
from qiskit_dynamics.pulse.channels import AcquireChannel, MemorySlot, DriveChannel
from qiskit_dynamics.pulse.exceptions import PulseError
from qiskit_dynamics.pulse.macros import measure
...
def lower_gates(
    ...
    """
    from qiskit_dynamics.pulse.transforms.base_transforms import target_qobj_transform
